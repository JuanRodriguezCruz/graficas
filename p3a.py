# coding=utf-8
"""Dibujo de triangulos que representan una montaña y una carpa"""
...
if __name__ == "__main__":
    ...
    window = glfw.create_window(width, height, "Drawing a mountain and a Tent", None, None)
    ...
    # 1- Creamos la Figura de la montaña en la GPU
    ...
    # 2- Creamos la Figura de la carpa en la GPU
    tentShape = createTriangle([-0.8, -0.8], [-0.4, -0.8], [-0.6, -0.5], [1.0, 1.0, 0.0],[1.0, 0.0, 0.0]) # Creamos los vertices e indices (guardandolos en un objeto shape)
